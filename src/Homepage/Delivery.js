...
const Delivery = () => {
    ...
    return (
        <section class="index-individuals">
            <div class="linkContainer2">
                <div class="barrier1"><p>Synchronizing payment and delivery
                    <span class="span1"> for consumers & merchants</span></p>

                    <p class="trust2">Tranxactrust partners with reliable
                    ...
                    <img class="green-location" src={green} alt="point-of-interest"/>
                    <div class="location">
                ...
                <div class="index-delivery">
                    ...
                    <div class="linkContainer3">
                        <div class="delivery">
                            <p class="edp">Express Delivery Protocol <acrony title="Express Delivery Protocol">(EDP)</acrony></p>

                            <div class="svgContainer">
                                <svg class="svg1" width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="35" cy="35" r="35" fill="#0887ef" />
                                </svg>
                                <svg class="svg2" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="description">
                            <p> Synchronise payment and product delivery on Tranxactrust.
                                ...
                                <span class="update" onClick={logistics}> Click here</span> to find available
                                ...
                                FedEx, etc. Passing our <acrony title="Express Delivery Protocol">EDP</acrony> clearance status is easy, clears
                                any doubts of time wasting and consolidates your capacity and
                                readiness to deliver paid products.
                            </p>

                                <button onClick={getSignUp} class="account2">Learn More
                    ...
                    <div class="deliveryman">
                        <p class="introHeader">Delivery to customers' location is easier
                            and time-saving when synchronized with payment on <span class="span2">
                                Tranxactrust.</span>
                        </p>

                        <img class="rectangle-image " src={deliver} alt="Delivery service" />
