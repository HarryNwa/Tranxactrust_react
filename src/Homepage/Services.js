            ...
            <div class="row1">
                <div class="linkContainer"> 
                    ...
                    <div class="description">
                        ...
                        <div class="moreContainer">Learn More
            ...
            <div class="row1">
                <div class="linkContainer">
                    <div class="crypto">
                        ...
                        <div class="svgContainer">
                            ...
                            <svg class="svg1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50" height="50" fill="#3498db">
                                <rect x="10" y="10" width="30" height="30" fill="#f6f8fa" />
                                <line x1="15" y1="25" x2="35" y2="25" stroke="#0887ef" stroke-width="4" />
                                <line x1="25" y1="15" x2="25" y2="35" stroke="#0887ef" stroke-width="4" />
                ...
                <div class="linkContainer">
                    <div class="support">
                        ...
                        <div class="svgContainer1">
                            <svg class="svg1" width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="35" cy="35" r="35" fill="#0887ef"/>
                            </svg>
                            <svg class="svg3" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg"> 
                    ...
                    <div class="description">
                        <p>Support is available every minute of the day. 
                            ...
                            <div class="moreContainer">Open your Shop Now
                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.34788 8.75L7.29163 10.8062L13.9708 17.5L7.29163 24.1938L9.34788 26.25L18.0979 17.5L9.34788 8.75Z" fill="#0887ef"/>
                                    <path d="M18.9583 8.75L16.902 10.8062L23.5812 17.5L16.902 24.1938L18.9583 26.25L27.7083 17.5L18.9583 8.75Z" fill="#0887ef"/>
                                </svg>
                ...
                <div class="linkContainer">
                    <div class="delivery">
                        <p class="api">API Documents for Developers</p>
                ...
                {/* <svg class="svg1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50" height="50" fill="#3498db">
                    ...
                    <line x1="15" y1="25" x2="35" y2="25" stroke="#f6f8fa" stroke-width="4" />
                    <line x1="25" y1="15" x2="25" y2="35" stroke="#f6f8fa" stroke-width="4" />
